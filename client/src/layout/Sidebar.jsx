...
const Sidebar = ({ showSidebar, setShowSidebar }) => {
  ...
  return (
    <div>
      ...
      ></div>
      <div
        className={`w-[230px] fixed bg-[#e6e7fb] z-50 top-0 h-screen shadow-[0_0_15px_0_rgb(34_41_47_/_5%)] transition-all ${showSidebar ? "left-0" : "-left-[260px] lg:left-0"
          } `}
      >
        {/* logo image */}
        <div className="h-[50px] flex justify-center items-center mb-6">
          ...
          <span
            onClick={() => setShowSidebar(false)}
            className={`${showSidebar ? "visible cursor-pointer text-2xl " : "invisible"
              } `}
          >
            <IoCloseCircleSharp />
          </span>
